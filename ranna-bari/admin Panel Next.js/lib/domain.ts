/**
 * The vocabulary, ported from the Expo app's `src/lib`.
 *
 * Codes, not sentences: the client turns these into the right language, and
 * this layer has no business knowing which one is on. Anything renamed here
 * silently breaks the mobile client, so nothing is renamed here.
 */
