...
export const bn = {
  ...
  'Max {n}': 'সর্বোচ্চ {n}',
  'Use the email and password for your kitchen.': 'আপনার রান্নাঘরের ইমেইল ও পাসওয়ার্ড দিন।',
  'Enter your email.': 'আপনার ইমেইল দিন।',
  'Enter your password.': 'আপনার পাসওয়ার্ড দিন।',
  'That email and password do not match.': 'এই ইমেইল ও পাসওয়ার্ড মিলছে না।',
  'Password': 'পাসওয়ার্ড',
  'Email': 'ইমেইল',
  'Welcome back, chef.': 'ফিরে আসায় স্বাগতম, শেফ।',
  'Sign in to your kitchen. No kitchen yet? We will set one up.': 'আপনার রান্নাঘরে সাইন ইন করুন। রান্নাঘর নেই? আমরা বানিয়ে দেব।',
  'Sign in to order from the kitchens near you.': 'কাছের রান্নাঘর থেকে অর্ডার করতে সাইন ইন করুন।',
  'How will you': 'আপনি কীভাবে',
  'use RannaBari?': 'রান্নাবাড়ি ব্যবহার করবেন?',
  'You can change your mind later — a cook orders dinner too.': 'পরে বদলাতে পারবেন — রাঁধুনিও তো রাতের খাবার অর্ডার করেন।',
  'I want to order food': 'আমি খাবার অর্ডার করতে চাই',
  'Browse home kitchens near you, order, and track it to your door.': 'কাছের ঘরোয়া রান্নাঘর দেখুন, অর্ডার করুন, দরজা পর্যন্ত ট্র্যাক করুন।',
  'Continue as a customer': 'ক্রেতা হিসেবে এগোন',
  'I cook and sell food': 'আমি রান্না করে বিক্রি করি',
  'Run your kitchen, take orders, and get paid. New here? You can register your kitchen.': 'রান্নাঘর চালান, অর্ডার নিন, টাকা পান। নতুন? রান্নাঘর নিবন্ধন করতে পারবেন।',
  'Continue as a cook': 'রাঁধুনি হিসেবে এগোন',
  'Ready to order?': 'অর্ডার করবেন?',
  'Keep browsing as long as you like — an account is only for ordering.': 'ইচ্ছেমতো ঘুরে দেখুন — অ্যাকাউন্ট শুধু অর্ডারের জন্য।',
  'Order from any kitchen': 'যেকোনো রান্নাঘর থেকে অর্ডার',
  'Track your food to the door': 'খাবার দরজা পর্যন্ত ট্র্যাক করুন',
  'Save your address and favourites': 'ঠিকানা ও পছন্দ সেভ করুন',
  'In': 'ঢুকুন',
  'Updates': 'আপডেট',
  'Remove all': 'সব সরান',
  'Empty the shelf basket?': 'দোকানের ঝুড়ি খালি করবেন?',
  'Everything you have picked from the shops goes. Your kitchen basket stays.': 'দোকান থেকে নেওয়া সব চলে যাবে। রান্নাঘরের ঝুড়ি থাকবে।',
  'Empty your basket?': 'আপনার ঝুড়ি খালি করবেন?',
  'Every dish here goes. Anything picked from the shops stays.': 'এখানকার সব পদ চলে যাবে। দোকান থেকে নেওয়া জিনিস থাকবে।',
  'To change quantities or remove something, go back to your basket.': 'সংখ্যা বদলাতে বা কিছু সরাতে ঝুড়িতে ফিরে যান।',
